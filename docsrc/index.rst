...
.. grid:: 2
  ...
  .. grid-item-card:: :fas:`person-hiking` :doc:`Getting Started <getting_started/index>`

    You can install the stable version of our package with 
  ...
  .. grid-item-card:: :fas:`code` :doc:`API Documentation <api/index>`
    ...
    All the fun backend documentation for developers.
